...
const generateAddition = () => {
    // num1 debe ser máximo (range - 1) para que num2 pueda ser al menos 1
    const num1 = Math.floor(Math.random() * (range - 1)) + 1;
    // num2 debe ser tal que la suma no exceda el rango
    const num2 = Math.floor(Math.random() * (range - num1)) + 1;
...
const generateSubtraction = () => {
    // num1 debe ser al menos 2 para que num2 pueda ser al menos 1
    const num1 = Math.floor(Math.random() * (range - 1)) + 2;
    // num2 debe ser menor que num1 y al menos 1
